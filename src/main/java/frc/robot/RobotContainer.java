...
public class RobotContainer {
  ...
  private void configureBindings() {
    new Trigger(shootingSubsystem.NoteSwitchPressed()).onTrue(noteCollectedAnimationCommand);
    new Trigger(shootingSubsystem.NoteSwitchNotPressed()).onTrue(noteMissingCommand);
